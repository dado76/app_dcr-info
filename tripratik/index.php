...
echo  ' Date :';
	...
	<input class="btn btn-primary"  type = "submit" value = "Chercher">
			...
			<a href="tripratikExport.php" target="_parent"><button type="button" href="tripratikExport.php" class="btn btn-primary btn"><i class="fa fa-file-excel"></i>Export Excel</button></a>
	</form>
						    ...
						    foreach ($db->query($sql) as $row) {
						    	...
						    	<tr>
						    		...
						    		<td><?php echo $row['BIO']; ?></td>
										<td><?php echo $row['OM_WEB']; ?></td>
						    		<td><?php echo $row['CS_WEB']; ?></td>
						    		<td><?php echo $row['BIO_WEB']; ?></td>
						    		<td>
