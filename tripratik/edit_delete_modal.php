        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php?id=<?php echo $row['id']; ?>">
				...
				<div class="row form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="OM_WEB" value="<?php echo $row['OM_WEB']; ?>">
					</div>
				</div>
								<div class="row form-group">
					<div class="col-sm-5">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="CS_WEB" value="<?php echo $row['CS_WEB']; ?>">
					</div>
				</div>
								<div class="row form-group">
					<div class="col-sm-5">
					...
					<div class="col-sm-5">
						...
						<input type="text" class="form-control" name="BIO_WEB" value="<?php echo $row['BIO_WEB']; ?>">
					</div>
				</div>
            </div>
			</div>
