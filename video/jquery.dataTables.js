	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sEmptyTable": "Pas de donnée valable ",
				"sLoadingRecords": "Chargement...",
				"sInfo": "Voir _START_ sur _END_ pour _TOTAL_ enregistrement",
				"sInfoEmpty": "Voir 0 sur 0 pour 0 enregistrement",
				"sInfoFiltered": "(filtered sur _MAX_ total entries)",
				"sInfoPostFix": "",
				"ssearch": "Recherche:",
				"sUrl": "",
				"oPaginate": {
                ...
                ($.inArray('asc', oCol.asSorting) == -1 && $.inArray('desc', oCol.asSorting) == -1) )
      {
		 ...
		 * Inputs:   -
		 * Notes:    All crmodifier for this function belongs to Alexandre Gomes. Thanks for sharing!
